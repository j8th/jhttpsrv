package com.eighthlight.jhttpsrv.testmessage.chrome.basicauthhandler;

public class GETlogsWithWrongAuthRequest {
    public final static String REQUEST_LINE = "GET /logs HTTP/1.1\r\n";
