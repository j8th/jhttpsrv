package com.eighthlight.jhttpsrv.testmessage.chrome.rangehandler;

public class GETrangeBlankto12Request {
    public final static String REQUEST_LINE = "GET /index.html HTTP/1.1\r\n";
